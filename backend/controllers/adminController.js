...
const changeDoctorPassword = async (req, res) => {
    try {
        ...
        if (!doctorId || !newPassword) {
            return res.json({ success: false, message: "Missing doctor ID or new password" });
        }
...
export { addDoctor, loginAdmin, allDoctor, appointmentsAdmin, appointmentCancel, adminDashboard, changeDoctorPassword }